...
namespace IIS.Pyatn
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pyatn.КлассБилета fКласс;
        ...
        public virtual IIS.Pyatn.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Pyatn.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Pyatn.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Pyatn.МестоНаРейс));
                }
            }
        }
    }
