...
namespace IIS.Pyatn
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pyatn.МестоНаРейс fМестоНаРейс;
        
        private IIS.Pyatn.КодБрони fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Pyatn.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Pyatn.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Pyatn.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Pyatn.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Pyatn.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Pyatn.Пассажир));
                }
            }
        }
    }
